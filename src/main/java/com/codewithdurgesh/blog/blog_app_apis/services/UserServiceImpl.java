...
import com.codewithdurgesh.blog.blog_app_apis.exceptions.*;
...
public User dtoToUser(UserDto userDto){
    User user = this.modelMapper.map(userDto, User.class); // alternate through modelmapper
...
UserDto userDto = this.modelMapper.map(user, UserDto.class); // alternate through modelmapper
